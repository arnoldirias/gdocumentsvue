...
<html lang="es">
  ...
  <body>
    ...
    <nav class="nav-extended" id="my-navbar">
      ...
      <div class="nav-content row">
        <ul class="tabs tabs-transparent" >
          <li class="tab col" v-for="tag, k in tags" @click="changeTag(k)">
    ...
    <div class="row content-main" >
      ...
      <div class="col s12 m9 l10" v-if="selectedTag==0 || selectedTag==2" style="display: none;"><!-- 0||1 -->
          <h5 class="center">Correspondencia {{filters[tipoFiltro-1]}}</h5>
          <div id="mostrar-cliente" class="">
            <table id="mytable2" v-if="mostrar_menu" class="striped highlight">
              <thead>
                <tr>
              ...
              <tbody>
                <tr v-for="doc, x in table">
                 ...
                 <!-- <td>{{str_ref(doc.correlativo, doc.referencia, doc.fecha_envio)}}</td> -->
      ...
      <div class="col s12 m9 l10" v-if="selectedTag==0 || selectedTag==2">
          ...
          <div class="material-table">
            <div class="table-header">
              ...
              <div id="search_input" class="input-field col l4 m4 s5">
                <textarea id="icon_prefix2" type="text" class="materialize-textarea" placeholder="Buscar:" @keyup.enter="anular"></textarea>
              </div>
            ...
            <table id="mytable" v-if="mostrar_menu" class="card striped highlight">
              <thead>
                <tr>
                <th class="pd15" scope="col">N°</th>
                  <th class="pd15" scope="col">Tipo de Documento<br>Referencia</th>
            ...
            <ul class="pagination">
              ...
              <li class="waves-effect" v-for="num, h in p"><a @click="changePag(h+1)">{{h+1}}</a></li>
